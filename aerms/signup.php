        ...
        <div class="row block-9">
          ...
          <div class="col-md-12 order-md-last d-flex">
            ...
            <form class="bg-white p-5 contact-form" method="post">
               <h2 style="text-align: center; font-weight: bolder; font-family: Arial, sans-serif;">Register with Us</h2>
              <div class="form-group">
                <label style="font-weight: bolder;">First Name <span>*</span> </label>
                <input type="text" value="" placeholder="Enter your first name" id="fname" name="fname" class="form-control" required='true'>
                
              </div>
              <div class="form-group">
                 <label style="font-weight: bolder;">Last Name <span>*</span></label>
                <input type="text" class="form-control" placeholder="Enter your last name" required="true" id="lname" name="lname">
              </div>
              <div class="form-group">
                 <label style="font-weight: bolder;">Email <span>*</span></label>
               <input type="email" value="" placeholder="Enter your email" id="email" name="email" class="form-control" required='true'>
              </div>
              <div class="form-group">
                <label style="font-weight: bolder;">Mobile Number <span>*</span></label>
               <input type="text" value="" placeholder="Enter your mobile number" id="mobilenumber" name="mobilenumber" maxlength="10" pattern="[0-9]+" class="form-control" required='true'>
              </div>
                <div class="form-group">
